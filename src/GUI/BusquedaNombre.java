...
public class BusquedaNombre extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Factura.txtCed.setText(cedula);
        Factura.txtCliente.setText(nombre);
        Factura.txtDireccionCl.setText(direccion);
    ...
    private void tblClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblClientesMouseClicked
        ...
        if(tblClientes.getSelectedRows().length>0){
            nombre = (String) tblClientes.getValueAt(fila, 0);
            cedula = (String) tblClientes.getValueAt(fila, 1).toString();
            direccion = (String) tblClientes.getValueAt(fila, 4);
        }
