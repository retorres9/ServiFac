...
public final class DetalleVentaVista extends javax.swing.JFrame {
    ...
    public void tablaVentas() {
        ...
        for (int i = 0; i < cantFilas; i++) {
            ...
            int idVentaVal = objVenta.getIntIdVenta();
            ...
            modelo.setValueAt(idVentaVal, i, 0);
    ...
    private void tblVentasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblVentasMouseClicked
        ...
        if (fila >= 0) {
            idVenta = tblVentas.getValueAt(fila, 0).toString();
    ...
    public static final javax.swing.JTable tblVentas = new javax.swing.JTable();
