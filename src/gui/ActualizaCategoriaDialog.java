...
public final class ActualizaCategoriaDialog extends javax.swing.JDialog {
    ...
    public ActualizaCategoriaDialog(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        manejadorMaterial = new DATMaterial();
        manejadorCategoria = new DATCategoria();
    ...
    public void cargarModeloCat() {
        try {
            ...
            listaCategorias = manejadorCategoria.obtenerCategoria();
    ...
    private void initComponents() {
        ...
        txtProducto.setText("jLabel1");

        jLabel2.setText("Escoga la nueva categoria de:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Categoria cat = (Categoria) jComboBox1.getSelectedItem();
        int id = cat.getIdCategoria();
        String strCat = cat.getStrCat();
        if(manejadorMaterial.actualizaCategoria(id, txtProducto.getText()) == true){
            ActualizacionDialog.txtCategoria.setText(strCat);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActualizaCategoriaDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ActualizaCategoriaDialog dialog = new ActualizaCategoriaDialog(new javax.swing.JDialog(), true);
    ...
    public final javax.swing.JLabel txtProducto = new javax.swing.JLabel();
